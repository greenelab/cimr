...
project = 'cimr'
copyright = '2018-2019, YoSon Park'
author = 'YoSon Park'
...
html_theme_options = {
    'navbar_links':[
        ('github', 'https://gihub.com/greenelab/cimr'),
    ],
...
latex_documents = [
    (master_doc, 'cimr.tex', 'cimr Documentation',
     'YoSon Park', 'manual'),
]
...
man_pages = [
    (master_doc, 'cimr', 'cimr Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cimr', 'cimr Documentation',
     author, 'cimr', 'One line description of project.',
     'Miscellaneous'),
]
